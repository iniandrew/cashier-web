                    ...
                    <form action="{{ route('cart.store') }}" method="post">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control" name="item_name" id="itemName" placeholder="Pilih Barang..." disabled required>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal"
                                                                onclick="
                                                                    ...
                                                                    $('#itemQty').attr('max', '{{ $item->stock }}')">Pilih</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="number" min="1" value="1" class="form-control" name="quantity" id="itemQty" placeholder="Masukan Jumlah..." required>
                                <div class="input-group-append">
                    ...
                    <form action="{{ route('transaction.store') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-10">
                                ...
                                <input type="number" class="form-control" name="total" placeholder="0" value="{{ $itemCarts->sum(function ($item) { return $item->price * $item->cart->quantity; }) }}" readonly required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="input-group col-sm-10">
                                ...
                                <input type="number" class="form-control" name="pay_total" placeholder="0" min="{{ $itemCarts->sum(function ($item){ return $item->price * $item->cart->quantity; }) }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('cart.update', $item->cart) }}" method="post">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="number" class="form-control" min="1" max="{{ $item->stock }}" value="{{ $item->cart->quantity }}" name="quantity" placeholder="Masukan Jumlah..." required>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">Unit</span>
                                                    </div>
                                                </div>
